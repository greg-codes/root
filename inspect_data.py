...
from myplots import make_countplot, utc_vs_local
...
ax = make_countplot(df_27, col='platform_device_make', count='clicks')
ax = make_countplot(df_27,col='platform_bandwidth', count='clicks')
ax = make_countplot(df_27,col='platform_carrier', count='clicks')
ax = make_countplot(df_27,col='platform_device_screen_size', count='clicks')
ax = make_countplot(df_27,col='creative_type', count='clicks')
ax = make_countplot(df_27,col='hour', count='clicks', order=False); ax.set_xlabel('local hour')
ax = make_countplot(df_27,col='tz', count='clicks'); ax.set_xlabel('time zone')
ax = make_countplot(df_27,col='state', count='clicks')

ax = utc_vs_local(df_27)
